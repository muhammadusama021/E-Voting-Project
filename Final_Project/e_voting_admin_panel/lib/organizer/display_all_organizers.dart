...
class DisplayAllOrganizers extends StatefulWidget {
  const DisplayAllOrganizers({Key key}) : super(key: key);

  @override
  _DisplayAllUsersState createState() => _DisplayAllUsersState();
}

class _DisplayAllUsersState extends State<DisplayAllOrganizers> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance.collection('Users').where('Status',isEqualTo: "ORGANIZER").snapshots(),
