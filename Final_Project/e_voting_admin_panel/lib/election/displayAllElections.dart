...
class DisplayAllElections extends StatefulWidget {
  const DisplayAllElections({Key key}) : super(key: key);

  @override
  _DisplayAllUsersState createState() => _DisplayAllUsersState();
}

class _DisplayAllUsersState extends State<DisplayAllElections> {
                      ...
                      children: [
                        ...
                        DefaultTextStyle(
                          style: GoogleFonts.titilliumWeb(
                              ...
                              color: greyBlack),
                          child: Text("Election Name: Voting for "+
                            singleUser["name"],
                          ),
                        ),
                        SizedBox(
    ...
    showDialog<String>(
      ...
      builder: (BuildContext context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              FireStoreMethods().deleteElection(uid);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: FirebaseFirestore.instance.collection('ElectionData').snapshots(),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.symmetric(horizontal: 8),
                                child: Text(
                                  snapshot.data.docs[position].data()["Start_time"],
                                  style: GoogleFonts.robotoCondensed(
                                    fontSize: 16,
                                  ),
                                ),
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.symmetric(horizontal: 8),
                                child: Text(
                                  snapshot.data.docs[position].data()["End_time"],
                                  style: GoogleFonts.robotoCondensed(
                                    fontSize: 16,
                                  ),
                                ),
